...
export default function Vision() {
  return (
    <div className="bg-vision px-8 py-12 h-[80rem] lg:h-[60rem] relative font-fontDM">
      ...
      <section className="sm:flex sm:flex-row sm:smfy-between lg:flex lg:flex-row lg:justify-between  lg:py-10 lg:z-5">
      ...
      <div className="sm:flex-1 lg:flex-1">
        <h1 className="text-4xl pb-4 font-bold">Vision</h1>
        <article className="text-xl pr-20">
